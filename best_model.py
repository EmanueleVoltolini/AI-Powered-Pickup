...
if __name__ == "__main__":
    ...
    #LEARNING_RATE = 0.01
    up_freq = 2048
    #AUDIO_DIR = "../input/guitar-pickup-microphone/Dataset"
    AUDIO_DIR = "../input/dataset"
    n_segments = 40
...
# %% Save the arrays that we are given to the network as a .wav audio files
    sf.write("in.wav", 44100, inp.astype(np.int16))
    sf.write("tar.wav", 44100, tar.astype(np.int16))
